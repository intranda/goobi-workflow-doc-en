...
Please read all the details in the [Vocabulary server documentation](https://gitea.intranda.com/intranda/vocabulary-server/src/branch/develop/docs/en/README.md).

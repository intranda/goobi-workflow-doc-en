...
## Version not yet published (SNAPSHOT 22.08)
...
### Move image comments
In order to move any existing image comments from the previous location to the new location, the following script must be called:

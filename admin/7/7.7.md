...
| Property | Type | Default value | Description |
| -------- | ---- | ------------- | ----------- |
| `showOcrButton` | Boolean | `false` | This value can be set to `true` to display a button in the metadata editor for running the OCR Analyze. |
...
| `ExportMetadataForProject` | Boolean | | This value can be set to `true` to include project data when exporting. |
| `ExportMetadataForInstitution` | Boolean | | This value can be set to `true` to include institution data when exporting. |

...
With the type `person`, a person can be selected. No further parameters or subelements are required.
...
With the type `corporate`, a corporate can be selected. No further parameters or subelements are required.
...
With the type `process`, a process can be selected. No further parameters or subelements are required.
...
The type `kulturnav` allows data transfer from the Kulturnav database across all integrated standards databases of different national libraries. No further parameters or subelements are required.
...
With the type `easydb`, a custom database can be specified to import information from. No further parameters or subelements are required.

...
![List of processes in Goobi](../../.gitbook/assets/16e.png)
...
![Adapt the list of processes in Goobi](../../.gitbook/assets/17e.png)
...
![List of processes with detailed view of one selected process](../../.gitbook/assets/18e.png)

In the example above, you can see which individual steps out of the workflow have already been completed by users, which are currently being processed and which are still locked until the preceding steps have been completed. You can search for one or more specific processes from the list at any time using the `Filter processes` box. Your search term will need to be entered using the correct syntax. For more information, please see [section Filtering processes](../../5/5.6/5.6.1.md).

A detailed description of all the functions provided by Goobi in process view can be found in the [section Goobi Management](../../5/), which contains further information about the functions described above and all other available options.

...
| Icon | Description |
| :--- | :--- |
| ![](../../../.gitbook/assets/039icon.png) | Entering the zoom level using the keyboard |

![Manually entering the required zoom level](../../../.gitbook/assets/039d-1.png)
...
![Specifying the representative image in the METS Editor](../../../.gitbook/assets/040d.png)

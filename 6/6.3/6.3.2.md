# 6.3.2. Mets parameters

The following screenshot shows the `Mets parameters` tab from Goobi’s project settings:

![Project configuration for METS parameters](../../.gitbook/assets/83e.png)
...
![Dialogue box for managing the generation of file groups](../../.gitbook/assets/84e.png)
